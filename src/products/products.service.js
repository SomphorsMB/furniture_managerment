...
var ProductsService = /** @class */ (function () {
    function ProductsService(_productRepository) {
    ...
    ProductsService.prototype.create = function (createProductDto) {
        return this._productRepository
            .createQueryBuilder()
            .insert()
            .values(__assign({}, createProductDto))
            .execute();
    };
    ProductsService.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._productRepository.createQueryBuilder('product')
    ...
    ProductsService.prototype.update = function (id, updateProductDto) {
        return this._productRepository.createQueryBuilder()
            .update(new update_product_dto_1.UpdateProductDto)
            .set(__assign({}, updateProductDto))
            .where("id = :id", { id: id })
            .execute();
    };
    ProductsService.prototype.remove = function (id) {
        return this._productRepository.createQueryBuilder()["delete"]()
