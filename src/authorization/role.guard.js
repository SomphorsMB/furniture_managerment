...
var RolesGuard = /** @class */ (function () {
    ...
    RolesGuard.prototype.canActivate = function (context) {
        ...
        // console.log(requiredRoles.some((role) => user.payload.role?.includes(role)));
        return requiredRoles.some(function (role) { var _a; return (_a = user.payload.role) === null || _a === void 0 ? void 0 : _a.includes(role); });
    };
