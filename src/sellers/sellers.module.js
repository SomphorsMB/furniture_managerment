...
var sellers_service_1 = require("./sellers.service");
var sellers_controller_1 = require("./sellers.controller");
var typeorm_1 = require("@nestjs/typeorm");
var seller_entity_1 = require("./entities/seller.entity");
var sellers_repository_1 = require("./sellers.repository");
var SellersModule = /** @class */ (function () {
    function SellersModule() {
    }
    SellersModule = __decorate([
        (0, common_1.Module)({
            imports: [typeorm_1.TypeOrmModule.forFeature([seller_entity_1.Seller, sellers_repository_1.SellerRepository])],
